...
At each finality have a "Row #". Click [here](https://github.com/TanguyLevent/Statistical-Methods-Table/blob/master/summary_table.pdf) it to find a summary table of the statistical method you choose.  
